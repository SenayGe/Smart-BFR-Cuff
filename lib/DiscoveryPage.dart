...
class _DiscoveryPage extends State<DiscoveryPage> {
  ...
  void _startDiscovery() {
    _streamSubscription =
      ...
      setState(() {
        var deviceExists = results.where((element) => element.device.address==r.device.address);
          if(deviceExists.isEmpty)results.add(r);
        });
    });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: isDiscovering
            ? Text('Discovering devices',style: TextStyle(color: Colors.black),)
            : Text('Discovered devices',style: TextStyle(color: Colors.black),),
